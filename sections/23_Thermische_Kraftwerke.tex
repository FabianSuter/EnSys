...
\subsection{Thermodynamik}
    ...
    \begin{tabular}{@{}l l}
        \textbf{isotherme:}     & $T = \text{const}\ W = m \cdot Ri \cdot T \cdot \mathrm{ln}\left(\frac{p2}{p1} \right)$\\
        \textbf{isochore:}      & $V = \text{const}\ Q = c_v \cdot m \cdot \Delta T$\\
        \textbf{isobare:}       & $p = \text{const}\ Q = c_p \cdot m \cdot \Delta T$\\
