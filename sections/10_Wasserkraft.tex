...
\begin{center}
    \includegraphics[width=0.85\columnwidth]{images/Kontinuitaet.png}
\end{center}
...
\begin{center}
    \includegraphics[width=0.85\columnwidth, align=c]{images/Bernoulli.png}
\end{center}
...
$
$\boxed{p = \left(H-z-\frac{v^2}{2g}\right)\cdot\rho g}$
...
\includegraphics[width=0.85\columnwidth, align=c, trim={0 90 0 5},clip]{images/Bild_übersicht_Wasserkraft.png}
...
\subsection{Örtliche Energieverluste}
    ...
    \begin{minipage}[t]{0.4\columnwidth}
        ...
        $\zeta = \left(1 - \left(\frac{d_1}{d_2}\right)^2\right)^2 \quad \text{für } d_1<d_2 $
    \end{minipage}

\subsubsection{Verlustbeiwerte Rohrgeometrie $\zeta$}
\begin{center}
    \includegraphics[width=\columnwidth]{images/Verlustbeiwerte.png}
\end{center}
...
\begin{minipage}[c]{0.48\columnwidth}
    \myul{\textbf{Rechteckquerschnitt}}
    ...
    \begin{minipage}[t]{0.55\columnwidth}
        ...
        $\boxed{R_h = \frac{b \cdot h}{b + 2 \cdot h} = \frac{F}{P}}$
    \end{minipage}
\end{minipage}
\hfill
...
\subsection{Verlustbeiwert alternativ $\lambda$}
\begin{minipage}[t]{0.45\columnwidth}
    $\boxed{
    \lambda = \left(\frac{1}{-2 \cdot \log \left( \frac{\varepsilon}{3{,}71} \right)}\right)^2 
            = \left(\frac{1}{-2 \cdot \log \left( \frac{k}{d_{hy} \cdot 3{,}71} \right)}\right)^2}$
\end{minipage}%
\hfill
\begin{minipage}[t]{0.44\columnwidth}
    ...
    \begin{tabular}{@{} l p{2.5cm} l @{}}
        $[\lambda]$         & Verlustbeiwert \dotfill       & $-$ \\
        $[k]$               & äquiv. Rauheit \dotfill       & mm \\
        $[d_{\text{hy}}]$   & Hydr. Durchmesser \dotfill    & m \\
    \end{tabular}
\end{minipage}
...
\begin{tabular}{@{} l p{6cm} l @{}}
    ...
    $[v_u]$         & Strömungsgeschwindigkeit im Unterwasser \dotfill & $\frac{\text{m}}{\text{s}}$ \\
...
$
\boxed{E = \int P_{\text{el}} \cdot \diff t}
\quad
\boxed{E = \rho \cdot g \cdot \int \eta_g \cdot \eta_t \cdot Q \cdot H_n \cdot \diff t}
$
