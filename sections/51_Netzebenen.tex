\section{Netzebenen}
    \begin{center}
        \includegraphics[width=0.85\columnwidth]{images/Netzebenen_1.png}
    \end{center}
...
\subsubsection{Schweizer Stromübertragungsnetz (Daten 2014)}
    \begin{center}
        \includegraphics[width=0.95\columnwidth]{images/Schweizer_übertragungsnetz.png}
    \end{center}
...
\subsubsection{Entso-E}
    ...
    \begin{minipage}[t]{0.6\columnwidth}
        ...
        \includegraphics[width=0.75\textwidth]{images/Entso_E.png}
    \end{minipage}%

    % \begin{center}
    %     \includegraphics[width=0.75\columnwidth]{images/Entso_E.png}
    % \end{center}
