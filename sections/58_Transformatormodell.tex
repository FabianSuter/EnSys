...
\subsection{Idealer Transformator}
    \begin{minipage}[t]{0.25\columnwidth}
        \includegraphics[width=0.95\columnwidth, align=c]{images/Idealer_Transformator_1.png}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.24\columnwidth}
        $
        \boxed{
            \frac{\underline{U_1}}{\underline{U_2}} = \frac{\underline{I_2}}{\underline{I_1}} = \frac{N_1}{N_2} =t
        }
        $
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.23\columnwidth}
        $
        \boxed{
            U_n = \omega \cdot N_n \cdot \frac{\phi}{\sqrt{2}}
        }
        $
    \end{minipage}
    \hfill
