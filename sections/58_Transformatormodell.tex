...
\subsection{Idealer Transformator}
    \begin{minipage}[t]{0.3\columnwidth}
        ...
        \includegraphics[width=0.9\columnwidth]{images/Idealer_Transformator_1.png}
        ...
        $\boxed{A_{FE}=\frac{\pi D^2 \cdot k_a \cdot f_{FE}}{4}}$
    \end{minipage}
    \hfill
...
\includegraphics[width=0.98\columnwidth]{images/TrafoBild.png}
...
\subsection{Praktisches Transformatormodell}
    \begin{minipage}[t]{0.6\columnwidth}
        \centering \vspace{-0.7\baselineskip}
        \includegraphics[width=0.9\linewidth]{images/Praktisches_Transformatorbild_2.png}
    \end{minipage}%
    \hfill
...
\subsection{Umrechnung von Impedanzen}
    \begin{minipage}[t]{0.39\columnwidth}
        \centering \vspace{-0.7\baselineskip}
        \includegraphics[width=0.9\columnwidth]{images/Umrechnung_Impedanzen_1.png}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.39\columnwidth}
        \centering \vspace{-0.7\baselineskip}
        \includegraphics[width=0.9\columnwidth]{images/Umrechnung_Impedanzen_2.png}
    \end{minipage}
    \hfill
...
\subsection{Leerlauf / Kurzschluss}
    \begin{minipage}[t]{0.46\columnwidth}
        ...
        $\boxed{\underline{I}_{1} = \underline{I}_{R_{FE}}+\underline{I}_{L_{h}}}$ 

        $\qquad \Downarrow$ 

        $\boxed{|\underline{I}_{1}| = \sqrt{|\underline{I}_{R_{Fe}}|^2+|\underline{I}_{L_{h}}}|^2}$
    \end{minipage}%
    \hfill
...
\subsection{Dreiphasentransformatoren}
    \begin{itemize}
        ...
        \item Parallelschaltung nur möglich, wenn sekundärs. gleiche „Zahl“ (Bsp. Yy0 und Dd0)
...
\subsection{Schaltgruppen}
    ...
    \begin{minipage}[t]{0.61\columnwidth}
        ...
        \begin{itemize}
            \item \textit{1. Buchstabe (groß):} Oberspannungsseite (OS)
            \item \textit{2. Buchstabe (klein):} Unterspannungsseite (US)
            \item \textit{Zahl (n):} Phasendr./Phasenversch. gg. OS: $n\cdot\angle30$
        \end{itemize}
    \end{minipage}

    \begin{center}
        \includegraphics[width=0.75\columnwidth]{images/Ansteuerung.png}
    \end{center}

\begin{center}
    \subsubsection{Übersetzungsverhältnisse}

    \begin{tabular}{c l c}
        \textbf{Schaltgruppe} & \textbf{Verhältnis}\\
        \toprule[.13em]
