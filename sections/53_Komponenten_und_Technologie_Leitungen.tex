...
\subsubsection{Mastenformen}
    \begin{multicols}{3}
        ...
        \begin{center}
            \includegraphics[width=0.9\columnwidth, align=b]{images/Mastenformen_1.png}
        \end{center}
        ...
        \begin{center}
            \includegraphics[width=0.9\columnwidth, align=b]{images/Mastenformen_2.png}
        \end{center}
        ...
        \begin{center}
            \includegraphics[width=0.9\columnwidth, align=b]{images/Mastenformen_3.png}
        \end{center}
    \end{multicols}
