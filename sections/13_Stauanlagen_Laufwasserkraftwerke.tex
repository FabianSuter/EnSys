...
Das Wasser muss immer fliessen können - weder gestoppt noch umgeleitet.
...
\begin{tabular}{@{}ll}
    \textbf{\textcolor{green}{Vorteile:}} & Druckhöhe vor den Trubinen ist grösser\\
    \textbf{\textcolor{red}{Nachteile:}}  & Geschwemsel lagert sich vor allem vor dem Rechen ab \\
    & Bei starkem Geschwemseltrieb muss eventuell sogar \\
    & das Kraftwerk abgestellt werden \\
\end{tabular}
...
\begin{minipage}[t]{0.49\columnwidth}
    ...
    \includegraphics[width=0.9\linewidth]{images/Seitenentnahme.png}
\end{minipage}
\hfill
\begin{minipage}[t]{0.49\columnwidth}
    \subsubsection{Stirnentnahme}
    \includegraphics[width=0.9\linewidth]{images/Stirnentnahme.png}
\end{minipage}

\subsubsection{Sohlenentnahme}
    \begin{minipage}[t]{0.49\columnwidth}
        \includegraphics[width=0.9\linewidth]{images/Sohlenentnahme.png}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.49\columnwidth}
        \vspace{-16mm}
...
\begin{center}
    \includegraphics[width=.85\linewidth]{images/CondaRechen.png}
\end{center}
...
\begin{itemize}
    ...
    \item $90\, \mathrm{\%}$ der Feststoffe, die grösser als $0,5\, \mathrm{mm}$ sind, werden abgehalten $\Rightarrow$ oft wird kein Entsander mehr benötigt
...
\subsection{Entsander}
    ...
    \begin{center}
        \includegraphics[width=0.9\linewidth]{images/Entsander.png}
    \end{center}
    ...
    \begin{itemize}
        \item Hochwasser, keine Konzentrationen verursachen 
                (Abfluss durch das natürliche Bachbett und keine Konzentration auf einen Ort, z.B. auf ein Ausgleichsbecken, welches überläuft)
        \item Verhinderung von Geschiebeeintrag in das Stollensystem bei Hochwasser 
                ($\Rightarrow$ wesentliche Minderung des Aufwands für die Wiederinbetriebnahme nach dem Hochwasser)
    \end{itemize}
...
\subsection{Verhinderung von Schwall und Sunk}
    \begin{itemize}
        \item \textbf{Schwall} kann zu Überschwemmungen führen 
        \item \textbf{Sunk} kann Schiffe auf Grund setzen
...
\subsection{Flusskraftwerkstypen}
    \subsubsection{Ausleitungskraftwerke (Umleitungskraftwerke)}
        \begin{minipage}[t]{0.49\columnwidth}
            \centering \vspace{-0.7\baselineskip}
                \includegraphics[width=0.9\textwidth]{images/Ausleitungskraftwerke.jpg}
        \end{minipage}%
        \hfill
        \begin{minipage}[t]{0.49\columnwidth}
            \begin{itemize}
    ...
    \begin{minipage}[t]{0.49\columnwidth}
        \subsubsection{Blockbauweise}\label{Bauweise 1}
            \centering
            \includegraphics[width=0.9\columnwidth]{images/Flusskraftwerke_Bauweise_1.jpg}
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.49\columnwidth}
        \subsubsection{Zwillingsbauweise}\label{Bauweise 2}
            \centering
            \includegraphics[width=0.9\columnwidth]{images/Flusskraftwerke_Bauweise_2.jpg}
    \end{minipage}

\subsubsection{Buchtenkraftwerk}\label{Bauweise 3}
\begin{center}
    \includegraphics[width=0.5\columnwidth]{images/Flusskraftwerke_Bauweise_3.jpg}
\end{center}

Moderne Flusskraftwerke werden heute gemäss \ref{Bauweise 1} gebaut.

Der Wirkungsgrad bei \ref{Bauweise 2} und \ref{Bauweise 3} ist schlechter als bei \ref{Bauweise 1}.

\subsection{Arten von Wehr- und Sektorverschlüssen}
    \begin{center}
        \includegraphics[width=0.8\columnwidth]{images/Arten_Wehr_und_Sektorverschlüsse_1.png}
        
        \includegraphics[width=0.8\columnwidth]{images/Arten_Wehr_und_Sektorverschlüsse_2.png}
    \end{center}