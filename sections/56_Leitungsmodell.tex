...
\subsection{Leitungsgleichungen}
    \begin{center}
        \includegraphics[width=0.8\columnwidth]{images/Leitungsgleichungen_1.png}
    \end{center}
...
\subsubsection{Übung Kraftwerk mit Doppelleitung an Netz}
    \begin{minipage}[t]{0.6\columnwidth}
        ...
        \includegraphics[width=\columnwidth]{images/u03_new.png}
    \end{minipage}
    \hfill
    \begin{minipage}[t]{0.39\columnwidth}
        % \vspace{-0.7\baselineskip}
        Siehe auch \ref{Leistungsübertragung}

        \smallskip

        Kraftwerk über Doppelleitung am Netz

        Spannung inkl. Winkel am Netz starr gegeben,

        $U_1$ mittels Iteration berechnen (\ref{PQIteration})
    \end{minipage}

\subsubsection{Übung Leitungen mit Leistungen}
    Drei parallel geschaltete Verbraucher an einer Quelle, Sternpunkt auf Lastseite

    $\boxed{S_{ges} = P_{ges} + j Q_{ges}}$
    $\boxed{\cos(\varphi_{ges}) = \dfrac{P_{ges}}{\abs{S_{ges}}}}$
    $\boxed{S_{ges} = 3 \cdot \left(\frac{U_{verk}}{\sqrt{3}}\right)^2 \cdot \frac{1}{Z^*}}$
