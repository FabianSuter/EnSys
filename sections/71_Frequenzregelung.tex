\section{Frequenzregelung}
    Frequenzstabilität bezieht sich auf die Fähigkeit eines Stromversorgungssystems, 
    eine konstante Frequenz nach einem schweren Systemstörfall aufrechtzuerhalten, 
    der zu einem signifikanten Ungleichgewicht zwischen Erzeugung und Last führt. 
    Sie hängt von der Fähigkeit ab, das Gleichgewicht zwischen Systemgeneration 
    und Last bei minimalem unbeabsichtigtem Lastverlust aufrechtzuerhalten bzw. wiederherzustellen.

\subsection{Modell eines einzelnen Synchrongenerators}
    \begin{minipage}[t]{0.35\columnwidth}
        \centering \vspace{-0.7\baselineskip}
        $\boxed{\frac{d\omega}{dt} = \frac{(P_{\text{Gen}} - P_{\text{Last}})}{2 \cdot H} }$
    \end{minipage}%
    \hfill
...
\subsection{Modell des elektrischen Netzes}
    \begin{minipage}[t]{0.35\columnwidth}
        % mehrere gekoppelte Synchrongeneratoren, \( i = 1, \ldots, N \)
        \centering \vspace{-0.7\baselineskip}
        $\boxed{\frac{d\omega_i}{dt} = \frac{(P_{\text{Gen,}i} - P_{\text{Last,}i})}{2 \cdot H_i} }$
    \end{minipage}%
    \hfill
    \begin{minipage}[t]{0.64\columnwidth}
        \begin{itemize}
...
\subsubsection{Frequenzstabilität}
    ...
    \begin{minipage}[t]{0.64\columnwidth}
        ...
        \begin{tabular}{@{} l p{4cm} l @{}}
            ...
            $[\Delta P]$ & Differenz Erzeugung/Verbrauch \dotfill & $\text{W}$ \\
...
\subsection{(n-1)-Sicherheitsprinzip}
    Das (n-1)-Sicherheitsprinzip besagt, dass der Ausfall eines beliebigen Betriebsmittels 
    (z.B. Leitung, Transformator, Kraftwerksblock) in einem elektrischen Netz zu keiner 
    Überlastung der verbleibenden Betriebsmittel und zu keinem Netzzusammenbruch führen darf. 
    Das Netz muss auch nach dem Ausfall einer Komponente noch stabil und sicher betrieben werden können.

\subsection{Primärregelung (Frequenz stabiliseren)}
    \begin{minipage}[c]{0.4\columnwidth}
        \begin{center}
            \includegraphics[width=0.75\textwidth]{images/Primärregelung_1.jpg}
        \end{center}
    \end{minipage}
    \begin{minipage}[c]{0.4\columnwidth}
        \begin{center}
            \includegraphics[width=0.85\textwidth]{images/Primärregelung_2.jpg}
        \end{center}
    \end{minipage}
    ...
    $\dfrac{d\omega}{dt} = \dfrac{1}{2H} \bigl(P_{\text{Gen}} - P_{\text{Last}} - K(\omega - \omega_0)\bigr)$
    $\quad$
    $\boxed{\omega = \omega_0 + \frac{1}{K} (P_{\text{Gen}} - P_{\text{Last}})}$

\subsection{Sekundärregelung (Frequenz auf 50Hz korr.)}
\begin{itemize}
...
\begin{minipage}[c]{0.48\columnwidth}
    \begin{center}
        \includegraphics[width=0.5\textwidth]{images/Bilanzfehler_1.jpg}
    \end{center}
\end{minipage}
...
\subsection{Tertiärregelung (Regelreserven frei machen)}
\begin{itemize}
...
\subsubsection{Transienten und Primärregelung}
    ...
    \begin{minipage}[c]{0.48\columnwidth}
        \begin{center}
            \includegraphics[width=0.98\textwidth]{images/Kraftwerksverlust_1.jpg}
        \end{center}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.48\columnwidth}
        \begin{center}
            \includegraphics[width=0.6\textwidth]{images/Kraftwerksverlust_2.jpg}
        \end{center}
    \end{minipage}
...
\subsubsection{Sekundärregelung}
    ...
    \begin{minipage}[c]{0.48\columnwidth}
        \begin{center}
            \includegraphics[width=0.98\textwidth]{images/Kraftwerksverlust_3.jpg}
        \end{center}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.48\columnwidth}
        \begin{center}
            \includegraphics[width=0.8\textwidth]{images/Kraftwerksverlust_4.jpg}
        \end{center}
    \end{minipage}
...
\subsubsection{Tertiärregelung}
    ...
    \begin{minipage}[c]{0.48\columnwidth}
        \begin{center}
            \includegraphics[width=0.98\textwidth]{images/Kraftwerksverlust_5.jpg}
        \end{center}
    \end{minipage}
    \hfill
    \begin{minipage}[c]{0.48\columnwidth}
        \begin{center}
            \includegraphics[width=0.8\textwidth]{images/Kraftwerksverlust_6.jpg}
        \end{center}
    \end{minipage}