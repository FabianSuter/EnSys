...
\subsection{Problemformulierung}
    \begin{center}
        \includegraphics[width=0.98\columnwidth]{images/Problemstellung_1.png}

        \includegraphics[width=0.98\columnwidth]{images/Problemstellung_2.png}
    \end{center}

\subsubsection{Iterationsformel}\label{PQIteration}
    Spannung $\underline{U}_2$ kann mittels Iteration approximiert werden.

    \includegraphics[width=0.5\linewidth]{images/PQIteration.png}
...
\includegraphics[width=0.75\columnwidth]{images/Nasenkurve.png}